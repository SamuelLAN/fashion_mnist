...
class Model(NN):
    ...
    def build(self):
        ...
        self.model = keras.Sequential([
            ...
            layers.Conv2D(6, 3, name='conv1_3', padding='same', strides=2,
            ...
            layers.Conv2D(16, 3, name='conv2_3', padding='same', strides=2,
                          kernel_initializer=self.params['kernel_initializer']),
            ...
            layers.Conv2D(64, 3, name='conv3_3', padding='same', strides=2,
                          kernel_initializer=self.params['kernel_initializer']),
            ...
            layers.Conv2D(128, 3, name='conv4_3', padding='same', strides=2,
                          kernel_initializer=self.params['kernel_initializer']),
            layers.BatchNormalization(name='bn4'),
            layers.Conv2D(256, 3, name='conv5_1', padding='same', kernel_initializer=self.params['kernel_initializer']),
            layers.Conv2D(256, 3, name='conv5_2', padding='same', kernel_initializer=self.params['kernel_initializer']),
            layers.Conv2D(256, 3, name='conv5_3', padding='same', strides=2,
                          kernel_initializer=self.params['kernel_initializer']),
            layers.Flatten(),

...
class ResNet34(tf.keras.Model):
    ...
    def __init__(self,
        ...
        self.l2c = id_block([64, 64], stage=2, block='c')

        self.l3a = conv_block([128, 128], stage=3, block='a')
        self.l3b = id_block([128, 128], stage=3, block='b')
        self.l3c = id_block([128, 128], stage=3, block='c')
        self.l3d = id_block([128, 128], stage=3, block='d')

        self.l4a = conv_block([256, 256], stage=4, block='a')
        self.l4b = id_block([256, 256], stage=4, block='b')
        self.l4c = id_block([256, 256], stage=4, block='c')
        self.l4d = id_block([256, 256], stage=4, block='d')
        self.l4e = id_block([256, 256], stage=4, block='e')
        self.l4f = id_block([256, 256], stage=4, block='f')

        self.l5a = conv_block([512, 512], stage=5, block='a')
        self.l5b = id_block([512, 512], stage=5, block='b')
        self.l5c = id_block([512, 512], stage=5, block='c')
